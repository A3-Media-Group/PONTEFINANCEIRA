...
$page_title = 'Simuladores Financeiros: Juros Compostos, Poupança e Financiamento | Ponte Financeira';
...
<section class="page-header" style="padding-bottom:40px">
    <div class="container">
        <p class="breadcrumbs" style="color:#C6D2DC">
            <a href="/" style="color:#C6D2DC">Início</a><span>/</span>Simuladores Financeiros
        </p>
